...
class HomePageLocators:
    SEARCH_INPUT = (By.XPATH, "//div[@role='search' and @aria-label='Site İçi Arama']//input[@data-test-id='search-bar-input']/parent::div")
...
class SearchResultsLocators:
    ...
    PRODUCT_COUNT_LABEL = (By.XPATH, "//h1[@data-test-id='header-h1']/span")
